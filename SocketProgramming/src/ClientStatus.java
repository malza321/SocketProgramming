// Fig. 10.10: ClientStatus.java
// This program provides implementation for 
// displaying all current users on the client side.
...
public class ClientStatus extends JFrame {
   ...
   public ClientStatus( String name, Login mc )
   {
      // create GUI
   ...
   public void initiateMessage( int index )
   {
      ...
      if ( client.findConversationIndex( target ) == -1 ){
    	 new ApplicationList(target, this, client);
      }
   }
